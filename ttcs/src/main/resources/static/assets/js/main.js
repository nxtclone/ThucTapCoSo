(function() {
	...
	function ScheduleTemplate( element ) {
		...
		this.timelineUnitDuration = 30; // getScheduleTimestamp(this.timelineItems[1].textContent) - getScheduleTimestamp(this.timelineItems[0].textContent);
	...
	ScheduleTemplate.prototype.openModal = function(target) {
		...
		if( mq == 'mobile' ) {
			...
			var HeaderBgScaleY = modalHeight/eventHeight,
				BodyBgScaleX = (modalWidth - eventWidth+150);
	...
	ScheduleTemplate.prototype.loadEventContent = function(content) {
		var self = this;
        		self.modal.getElementsByClassName('cd-schedule-modal__event-info')[0].innerHTML = self.getEventContent(`<div class="cd-schedule-modal__event-info">
        <div>`+content+`</div>
        </div>`);
